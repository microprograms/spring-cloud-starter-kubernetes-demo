...
COPY target/spring-cloud-starter-kubernetes-demo-*.jar spring-cloud-starter-kubernetes-demo.jar

EXPOSE 8080

ENV JAVA_OPTS="-XX:+UseContainerSupport -XX:MaxRAMPercentage=80.0 -XX:InitialRAMPercentage=75.0"

ENTRYPOINT java ${JAVA_OPTS} -jar spring-cloud-starter-kubernetes-demo.jar